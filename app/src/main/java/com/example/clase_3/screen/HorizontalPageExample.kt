...
import com.example.clase_3.R
import com.example.clase_3.ui.theme.Orange
...
fun Content2(){
    Column(
        ...
        {
            Text(text = "L O G I N", color = Color.Black, fontSize = 15.sp)
        }
...
fun Content() {
    Column(
        ...
        Button(
            ...
            Text(text = "VERIFY EMAIL", color = Color.Black, fontSize = 15.sp)
        }
